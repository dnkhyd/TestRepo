...
case 'imgedit-preview' :
	...
	include_once( ABSPATH . 'blogAdmin/includes/image-edit.php' );
...
case 'menu-quick-search':
	...
	require_once ABSPATH . 'blogAdmin/includes/nav-menu.php';
...
case 'replyto-comment' :
	...
	ob_start();
		if ( 'dashboard' == $mode ) {
			require_once( ABSPATH . 'blogAdmin/includes/dashboard.php' );
...
case 'lj-importer' :
	...
	include( ABSPATH . 'blogAdmin/import/livejournal.php' );
