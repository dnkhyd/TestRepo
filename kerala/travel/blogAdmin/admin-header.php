...
<body class="blogAdmin no-js <?php echo apply_filters( 'admin_body_class', '' ) . " $admin_body_class"; ?>">
<script type="text/javascript">
//<![CDATA[
(function(){
...
require(ABSPATH . 'blogAdmin/menu-header.php');
...
if ( $parent_file == 'options-general.php' )
	require(ABSPATH . 'blogAdmin/options-head.php');
