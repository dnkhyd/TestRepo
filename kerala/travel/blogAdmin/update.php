...
include_once ABSPATH . 'blogAdmin/includes/class-wp-upgrader.php';
...
if ( isset($_GET['action']) ) {
	...
	if ( 'update-selected' == $action ) {
		...
		require_once( ABSPATH . 'blogAdmin/includes/class-wp-upgrader.php' );
		...
		include_once ABSPATH . 'blogAdmin/includes/plugin-install.php'; //for plugins_api..
		...
		include_once ABSPATH . 'blogAdmin/includes/theme-install.php'; //for themes_api..
