...
$this->current_settings['sbb_round_box_enabled'] = 'N';
		...
		$html .= "<div id=\"itsmeDiv\" class=\"social_bookmark\">\n";
...
//				$html .= "<a href=\"#\" onclick=\"$$('div.d').each( function(e) { e.visualEffect('slide_up',{duration:0.5}) }); return false;\">Hide Sites</a> | ";
			...
			$html .= "<a title=\"Click me to see the sites.\" href=\"#\" onclick=\"$$('div.d$id').each( function(e) { e.visualEffect('slide_down',{duration:2.5}) }); return false;\"  class='stButton' style='line-height:-10px;'><font face='Verdana, Arial, Helvetica, sans-serif' size='2'>{$this->current_settings['sbb_label']}</font></a>\t";
		}
		else
		{
			$html .= "<div class=\"d\" style='vertical-align:top;'>";
			$html .= "<a class='stButton' style='cursor:default;line-height:-10px;vertical-align:top;'><font face='Verdana, Arial, Helvetica, sans-serif'  size='2' >{$this->current_settings['sbb_label']}</font></a>\t";
		}
