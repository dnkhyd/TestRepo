<?php 
	//include_once $_SERVER['DOCUMENT_ROOT'].'/views/headerebs.php';
	//$tab	=	"home"; 
...
function fillAllShippingFields()
{
	 frm = document.frmTransaction;
	 
   document.getElementById('ship_name').value = frm.name.value;
	 document.getElementById('ship_address').value = frm.address.value;;
	 document.getElementById('ship_city').value = frm.city.value;;
   document.getElementById('ship_state').value = frm.state.value;;
	 document.getElementById('ship_postal_code').value = frm.postal_code.value;;
	 document.getElementById('ship_country').value = frm.country.value;
   document.getElementById('ship_phone').value = frm.phone.value;
...
<div style="margin-left:auto; margin-right:auto; width:500px; ">
 <form  method="post" action="http://secure.ebs.in/pg/ma/sale/pay/" name="frmTransaction" id="frmTransaction" onSubmit="return validate();fillAllShippingFields();">
  <table width="80%" cellpadding="2" cellspacing="0" border="0" align="center">
      ...
      <input name="mode" type="hidden" size="60" value="LIVE"  readonly="readonly"/>
  <tr>
    <th height="45" colspan="2"><div align="center"><span class="ebs_selectd">Transaction Details</span></div></th>
  </tr>
  <tr>
    <td class="ebs_infotxt"><span class="error">*</span>Reference No</td>
    <td  align="left"><input name="reference_no" type="text" style="width:250px"/></td>
  </tr>
  <tr title="Enter the Price of the product that is offered for sale">
    <td class="ebs_infotxt" ><span class="error">*</span>Sale Amount</td>
    <td  align="left" ><input name="amount" type="text"/>
      <strong>INR</strong></td>
  </tr>
  <tr  title="Displays the description of the selected / ordered product.">
    <td class="ebs_infotxt" ><span class="error">*</span>Description</td>
    <td  align="left"><textarea name="description" rows="2" style="width:250px" ></textarea></td>
  </tr>
  <tr>
    <th height="45" colspan="2"><span class="ebs_selectd">Billing Address</span></th>
  </tr>
  <tr>
    ...
    <td align="left">
   	<input name="name" type="text" maxlength="255"  
                 onKeyDown="fillShippingFields('ship_name',this.value)"  
                  ...
                  onblur="fillShippingFields('ship_name',this.value)" style="width:250px"/> </td>
  </tr>
  <tr>
    ...
    <td align="left"><input name="address" type="text" onKeyDown="fillShippingFields('ship_address',this.value)"  
                 ...
                 onblur="fillShippingFields('ship_address',this.value)" style="width:250px"/>    </td>
  </tr>
  <tr>
    ...
    <td align="left"><input name="city" type="text" onKeyDown="fillShippingFields('ship_city',this.value)"  
                 ...
                 onblur="fillShippingFields('ship_city',this.value)" style="width:250px"/>    </td>
  </tr>
  <tr>
    ...
    <td align="left"><input name="state" type="text" onKeyDown="fillShippingFields('ship_state',this.value)"  
                  ...
                  onblur="fillShippingFields('ship_state',this.value)" style="width:250px" />    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left"><select name="country" onchange="fillShippingFields('ship_country',this.value)" style="width:250px">
  ...
  <tr>
    ...
    <td align="left"><input name="email" type="text" style="width:250px"/>    </td>
  </tr>
  <tr>
    ...
    <td align="left">
       <div>
         <div style="float:left;">
            <input name="submitted" value="" type="submit"  class="dummyClass sbmt_btn"/>
         </div>
         <div style=" float:left; padding-left:10px;">
            <input name="reset" type="reset" value="" style="font-family:Arial, Helvetica, sans-serif;" class="dummyClass reset"/>
         </div>
       </div>   
     </td>
  </tr>
...
<?php } else {?>
  <div align="center" style="padding:100px 0px 100px 0px;">
