...
<script language="JavaScript">
    parent.document.getElementById('mainIframe').height = 500;
</script>
...
<?php } else {?>
<script language="JavaScript">
    parent.document.getElementById('mainIframe').height = 300;
</script>
  <div style="margin-left:auto; margin-right:auto; width:600px; height:600px; border:0px solid red; padding:100px 0px 100px 0px; " >
